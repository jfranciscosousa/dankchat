...
! function(a, b) {
  ...
  var a = function(b) {
    ...
    var c = this.hashtag;
    if (c !== !1 && "twitter" !== c && "facebook" !== c) throw new Error("invalid `hashtag` cfg - see docs")
  };
  return a.prototype = {
    constructor: a,
    urls: !0,
    ...
    link: function(a) {
      ...
      for (var b = this.getHtmlParser(), c = b.parse(a), d = 0, e = [], f = 0, g = c.length; g > f; f++) {
        var h = c[f],
          i = h.getType(),
          j = h.getText();
        if ("element" === i) "a" === h.getTagName() && (h.isClosing() ? d = Math.max(d - 1, 0) : d++), e.push(j);
        else if ("entity" === i || "comment" === i) e.push(j);
        else if (0 === d) {
    ...
    parseTextAndEntityNodes: function(b) {
      for (var c = [], d = a.Util.splitAndCapture(b, this.htmlCharacterEntitiesRegex), e = 0, f = d.length; f > e; e += 2) {
        var g = d[e],
          h = d[e + 1];
    ...
    processCandidateMatch: function(b, c, d, e, f, g, h, i, j, k, l, m, n) {
      var o, p = i || j,
        q = "",
        r = "";
      if (g && !this.urls || f && !this.email || k && !this.phone || c && !this.twitter || l && !this.hashtag || !this.matchValidator.isValidMatch(g, h, p)) return null;
      if (this.matchHasUnbalancedClosingParen(b)) b = b.substr(0, b.length - 1), r = ")";
      else {
        var s = this.matchHasInvalidCharAfterTld(g, h);
        s > -1 && (r = b.substr(s), b = b.substr(0, s))
      }
      if (f) o = new a.match.Email({
        matchedText: b,
        email: f
      });
      else if (c) d && (q = d, b = b.slice(1)), o = new a.match.Twitter({
        matchedText: b,
        twitterHandle: e
      });
      else if (k) {
      ...
      } else if (l) m && (q = m, b = b.slice(1)), o = new a.match.Hashtag({
        matchedText: b,
        ...
        if (p) {
          var u = p.match(this.charBeforeProtocolRelMatchRegex)[1] || "";
          u && (q = u, b = b.slice(1))
        }
        o = new a.match.Url({
          matchedText: b,
    ...
    matchHasInvalidCharAfterTld: function(a, b) {
      ...
      var d = /^((.?\/\/)?[A-Za-z0-9\.\-]*[A-Za-z0-9\-]\.[A-Za-z]+)/,
        e = d.exec(a);
